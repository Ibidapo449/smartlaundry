...
class ProfileSuccessfulModal extends StatelessWidget {
  const ProfileSuccessfulModal({super.key});
          ...
          TextSemiBold("Successful !",
            ...
            Padding(
              ...
              child: BusyButton(
                ...
                onTap: (){
                      Navigator.pushNamed(
                          context, RouteName.updatedProfilePage);  
                }
                ),
            )
        ],
